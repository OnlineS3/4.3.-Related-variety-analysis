	...
	<div id="page">
		...
		<div id="mainpage" class="site">
			...
			<div class="site-content">
				<form class="form-wrapper" action="region.php" method="get">
					<select id="search" name="country" placeholder="Search for country..." required>
						<?php
						require_once $_SERVER['DOCUMENT_ROOT'] . '/related_var/backend/getCountries.php';
						$array = getCountries();
